...
// Fixed physical spectra for a synthetic reference display. The primary
// shapes are generated by fitting smooth Gaussian mixtures to the standard
// 1931 2-degree chromaticities of the requested RGB space. Their relative
// powers are then calibrated once so equal drive reproduces D65 for the
// 1931 2-degree observer. Those scaled spectra are frozen and reused for every
// observer.
...
// display. RGB->XYZ is formed by integrating the already-scaled physical
// primary spectra with the selected observer. No observer-dependent primary
// rescaling is performed. XYZ->RGB is the inverse of that matrix.
